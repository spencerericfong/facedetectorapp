...
class SignIn extends React.Component {
    ...
    onClickSignIn = () => {
        fetch('https://whispering-stream-55808.herokuapp.com/signin', {
            method: 'post',
    ...
    render() {
        ...
        return (
            <div>
                ...
                <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center" onKeyPress={this.onEnterSignIn}>
